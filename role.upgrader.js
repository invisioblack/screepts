...
module.exports = {
  ...
  spawnCondition: function(spawn) {
    ...
    let numberCondition = spawn.room.energyCapacityAvailable > 350*(numUpgraders.length || 0);
    let energyCondition = spawn.room.energyAvailable >= 0.7*spawn.room.energyCapacityAvailable;
